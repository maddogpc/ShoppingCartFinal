...
public class AddProductFragment extends Fragment {
    ...
    EditText pName, pCost, pDesc;
    Button pConfirm, pCancel;
    ...
    public void addProduct(String name, String cost, String desc, String sname) {
        ConcreteProductBuilder productBuilder = new ConcreteProductBuilder()
                .setProductName(name)
